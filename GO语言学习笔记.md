...
我也没学多少---->[官方文档](https://pkg.go.dev/github.com/dgrijalva/jwt-go)---->[github文档](https://github.com/dgrijalva/jwt-go)
...
> 我用的`fyne`库，也算比较热门，就是要下`gcc`，把`gcc`下好就行了[gcc下载网站](https://jmeubank.github.io/tdm-gcc/)
...
// 初始化
    apps := app.New()
    // 标题
	window := apps.NewWindow("你好")
	// 内容
	hello := widget.NewLabel("你好 Fyne")
	window.SetContent(container.NewVBox(
	// 按钮
		hello, widget.NewButton("嗨", func() {
			hello.SetText("欢迎")
		}),
	))
    // Run
...
package command-line-arguments
	...
	imports github.com/go-gl/gl/v3.2-core/gl: build constraints exclude all Go files in E:\golang\pkg\mod\github.com\go-gl\gl@v0.0.0-20211210172815-726fda9656d6\v3.2-core\gl
```


> 找了半天终于找到了  是我的go版本太高了，我<font style="color:red">`go get -u all`</font> 更新下还是不行，我又去下了最新版 的gcc，后面重启电脑自己就好了，就离谱

### .2 这章就放一放，网上没教程，文档内容太少了
